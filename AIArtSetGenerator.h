...
struct AIArtSetGeneratorSuite
{
	...
	*/
	...
	/** Each art in the output is a top level layer in the current document.
		@param skipHiddenLayers [in] skip hidden layers
		@param skipTemplateLayers [in] skip hidden layers
	*/
	AIAPI AIErr (*GenerateForTopLevelLayersEx) ( AIArtSet outArtSet, AIBoolean skipHiddenLayers, AIBoolean skipTemplateLayers );

	/** Each art in the output is a direct child of a layer group such that the
		art intersects with the artboard at the given index.
		@param skipHiddenArts [in] skip hidden Arts
		@param skipTemplateLayers [in] skip template layers
	*/
	AIAPI AIErr (*GenerateForNthArtboardEx) ( ai::ArtboardID inArtboardIndex, AIArtSet outArtSet, AIBoolean skipHiddenArts, AIBoolean skipTemplateLayers );
};
