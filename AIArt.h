...
/** @ingroup Notifiers
	Sent when an object attribute kArtExpanded changes
*/
#define kAIArtExpandedChangedNotifier		"AI Art Layers Palette Expand Changed Notifier"
...
enum AIArtType {
    ...
    kLastArtType = kConcentricRepeatArt,
};
...
enum AIArtUserAttr {
	...
	*/
    ...
    /**  Primary arts of repeat objects are included in the search for matching art, valid only for matching.*/
...
enum AIArtBoundsOptions {
    ...
    /** Internal only: Returns pre-transformed bounds  must be used with kControlBounds */
    kNonXformBounds = 0x0080,
};
...
enum AIArtTimeStampOptions
{
	...
	kAITimeStampOfDescendents = kAITimeStampMaxFromArtAndChildren << 1,

	kAINonRenderTimeStamp = kAITimeStampOfDescendents << 1
};
