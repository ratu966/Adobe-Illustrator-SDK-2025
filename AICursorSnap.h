...
@endcode
	...
	- "Blend",			"A v",				"A v",
	- "Select",			"A v o f",			"ATFPLMG v i o f",
	- "RangeSelect",	"",					"",
	- "Zoom",			"",					"",
	- "Page",			"ATFPG v i o",		"ATFPG v i o",
	- "Ruler",			"ATFPGX v i o",		"ATFPMGX v i o",
	- "Guide",			"ATFPGX v i o",		"ATFPGX v i o",
	- "Scissor",		"ATFL v i o",		"ATFPLG v i o",
	- "SquareCircle",	"ATFPG v i o",		"ATFPG v i o",
	- "Pen",			"ATFPLMGSU v i o",	"ATF v i o",
	- "Translate",		"ATFPG v i o",		"ATFPBLMG v i o",
	- "Scale",			"ATFPGXY v i o",	"ATFPBLMGXY v i o",
	- "Rotate",			"ATFPGXY v i o",	"ATFPLMGXY v i o",
	- "Reflect",		"ATFPGXY v i o",	"ATFPLMGXY v i o",
	- "Shear",			"ATFPG v i o",		"ATFPLMG v i o",
		...
		the "Snap To Point" application preference.
			...
			@param control How snapping is performed, a string containing
				...
				\li An uppercase character enables a constraint:
                    ...
                    - N: Enable angular snapping to automatically generated guidelines along the angular regions on canvas (currently support only for text objects)
