...
typedef struct {
	...
	/** Update clipboard contents
		...
		*/
	AIAPI AIErr (*UpdateClipboard) (const ai::AutoBuffer<ai::uint8>& buffer, const ai::UnicodeString& type);

	/** Reset the contents on clipboards */
	AIAPI AIErr (*ResetClipboard) ();

	/** Get clipboard contents for an object type
			@param buffer [out] in which clipboard contents will be set.
			@param type Object type.
		*/
	AIAPI AIErr (*GetClipboardData) (ai::AutoBuffer<ai::uint8>& buffer, const ai::UnicodeString& type);
