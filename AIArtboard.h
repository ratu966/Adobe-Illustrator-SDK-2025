...
#define kAIArtboardSuiteVersion			AIAPI_VERSION(8)
...
struct AIArtboardSuite{
    ...
    */
    ...
    /** Retrieves the absolute ruler origin of an artboard.
    @param properties The artboard properties object.
    @param rulerOrigin [out] A buffer in which to return ruler origin.
    */
    AIAPI AIErr (*GetRulerOriginAbsolute)(const ai::ArtboardProperties& properties, AIRealPoint& rulerOrigin);
    
    /** Sets the absolute ruler origin of the artboard
    @param properties The artboard properties object.
    @param rulerOrigin The new ruler origin.
    */
    AIAPI AIErr (*SetRulerOriginAbsolute)(ai::ArtboardProperties& properties, const AIRealPoint& rulerOrigin);
#endif
	...
	*/
	...
	/** Retrieves color of the artboard.
	@param properties The artboard properties object.
	@param color [out] AIColor object to return artboard color.
	*/
	AIAPI AIErr (*GetColor)(const ai::ArtboardProperties& properties, AIColor& color);

	/** Sets the color of artboard.
	@param properties The artboard properties object.
	@param color [in]  AIColor value to set.
	@note Only AIColorTag::kNoneColor, AIColorTag::kThreeColor and AIColorTag::kFourColor color are supported.
	*/
	AIAPI AIErr (*SetColor)(ai::ArtboardProperties& properties, const AIColor& color);
};
