...
#pragma options align=reset
    ...
    struct SPPlatformFileInfoLight {
...
#define kMaxPathLength 300
    ...
    /** Internal */
    typedef SPBoolean (*SPAddPiPLFilterProc)( SPPlatformFileInfoLight *info );
    ...
    typedef struct SPFilesSuite {
        ...
        SPAPI SPErr (*GetFileInfoLight)( SPFileRef file, SPPlatformFileInfoLight *info);
    ...
    /** internal */
    SPAPI SPErr SPGetFileInfoLight( SPFileRef file, SPPlatformFileInfoLight *info);
    /** Internal */
