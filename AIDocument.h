...
#define kAIDocumentSuiteVersion21			AIAPI_VERSION(21)

// latest version
#define kAIDocumentSuiteVersion			kAIDocumentSuiteVersion21
#define kAIDocumentVersion				kAIDocumentSuiteVersion

#define kAIDefaultSaveArtboardIndexSuffix 		true
...
/** @ingroup Notifiers
	Sent when a document copy has been written to the disk successfully. See \c #AIDocumentWriteCopyOnDiskCompleteNotifyData
	\c #kAIDocumentSavedNotifier*/
#define kAIDocumentWriteCopyOnDiskCompleteNotifier	"AI Document Write Copy On Disk Complete Notifier"
/** @ingroup Notifiers
	Sent when a document copy writing to the disk get failed. See \c #AIDocumentWriteCopyOnDiskFailedNotifyData
	\c #kAIDocumentSavedNotifier*/
#define kAIDocumentWriteCopyOnDiskFailedNotifier	"AI Document Write Copy On Disk Failed Notifier"
...
struct AISaveMultipleArtboardsParameters
{
    ai::int32          fType;
    AIBoolean              fAllArtboards;
    AIBoolean              fSaveSuffix;
    ai::UnicodeString fRange;
    AISaveMultipleArtboardsParameters()
        : fType(0),
        fAllArtboards(false),
        fSaveSuffix(kAIDefaultSaveArtboardIndexSuffix)
    {}
};
#if !defined(ILLUSTRATOR_MINIMAL)
...
sAIDocument->GetTextSelection(&selectionRef);
{
	...
	AIAPI AIErr (*WriteDocumentWithOptions) (const ai::FilePath &file, const char *fileFormatName,
		ai::int32 fileFormatOptions, AIDictionaryRef additionalOptionsDict, AIBoolean askForParms, AISaveMultipleArtboardsParameters *mabInfo);
