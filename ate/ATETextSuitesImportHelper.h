...
#define EXTERN_TEXT_SUITES\
    ...
    ATE::ListStyleSuite* sListStyle;\
    ATE::ListStyleSetSuite* sListStyleSet;\
    ...
    ATE::ArrayListStyleRefSuite* sArrayListStyleRef;\
    ATE::ArrayListStyleSetRefSuite* sArrayListStyleSetRef;\
...
#define IMPORT_TEXT_SUITES\
    ...
    { kListStyleSuite, kListStyleSuiteVersion, &sListStyle },\
    { kListStyleSetSuite, kListStyleSetSuiteVersion, &sListStyleSet },\
    ...
    { kArrayListStyleRefSuite, kArrayListStyleRefSuiteVersion, &sArrayListStyleRef },\
    { kArrayListStyleSetRefSuite, kArrayListStyleSetRefSuiteVersion, &sArrayListStyleSetRef },\
