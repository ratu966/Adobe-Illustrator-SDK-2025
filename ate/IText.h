...
class IArrayListStyleRef;
class IArrayListStyleSetRef;
...
public:
    ...
    /** Retrieves the character range of this glyphrun
        */
    ITextRange GetCharacterRange() const;
    ...
    */
    ...
    /** Retrieves x height in the font for this run.
            @return The height value, in document points.
        */
    ATETextDOM::Real GetXHeight() const;
...
//       --IListStyle--
//////////////////////////////////////////////
/** Encapsulates the ListStyle characteristics of a character as a text resource.
    The methods allow you to add, access, and manipulate ListStyle for use with the
     Adobe Text Engine (ATE). These objects are collected in an \c IListStyleSet.
    */
class IListStyle
{
private:
    ListStyleRef fListStyle;
public:
    /** Constructor
            @return The new object. */
    IListStyle();
    /** Copy constructor
            @param src The object to copy.
            @return The new object. */
    IListStyle(const IListStyle& src);
    /** Assignment operator.
            @param rhs The object to assign to this one.
            @return A reference to this object. */
    IListStyle& operator=(const IListStyle& rhs);
     /** Comparison operator tests for equality.
            @param rhs The object to compare to this one.
            @return True if the two objects are the same.   */
    bool operator==(const IListStyle& rhs) const;
    /** Comparison operator tests for inequality.
            @param rhs The object to compare to this one.
            @return True if the two objects are not the same.   */
    bool operator!=(const IListStyle& rhs) const;
    /** Constructs this C++ object from the corresponding C object
        returned by an ATE suite function.
        The C++ object manages reference counting.
            @param ListStyle The C object.
            @return The new C++ object. */
    explicit IListStyle(ListStyleRef listStyle);
    /** Destructor */
    virtual ~IListStyle();
    /** Retrieves a reference to this object.
            @return The object reference.   */
    ListStyleRef GetRef() const;
    /** Reports whether this is a null object.
            @return True if this is a null object. */
    bool IsNull() const;
    ...
    /** Retrieves the number of sub level in this list object.
            @return The number of levels.
        */
    ATETextDOM::Int32 GetNumberOfLevelStyles( ) const;
    /** Retrieves the Nth level indents of this list object, give the einput emWidth
             @param index : Nth level position
             @param  listIndent - This is the accumuulated text indent till the Nth level of this list
            @param  textIndent - This is the text indent of Nth level of this list
            @param  labelIndent -This is the label indent of Nth level of this list
        */
    void GetNthTierIndents(ATETextDOM::Int32 index,
                               ATETextDOM::Float   emWidth,
                               ATETextDOM::Float * listIndent,
                               ATETextDOM::Float * textIndent,
                                ATETextDOM::Float * labelIndent);
    /** Retrieves the Nth level text indent of this list object
             @param index : Nth level position
            @param  textIndent - This is the text indent of Nth level of this list
        */
    void GetNthLevelTextIndent(ATETextDOM::Int32 index,
                               ATETextDOM::Float * textIndent);
    /** Retrieves the Nth level label indent of this list object
             @param index : Nth level position
            @param  labelIndent - This is the text indent of Nth level of this list
        */
    void GetNthLevelLabelIndent(ATETextDOM::Int32 index,
                               ATETextDOM::Float * labelIndent);
    /** Retrieves the Nth level label Alignment of this list object,
             @param index : Nth level position
             @param  labelAlignment --This is the  label Alignment of Nth level of this list
        */
    void GetNthLevelLabelAlignment(ATETextDOM::Int32   index,
                                               ATE::BNListAlignment& labelAlignment);
    /** Retrieves the font of label of Nth level in this list object.
             @param index : Nth level position
             @param useOriginalFont: do we need to rememer the font while label rendering
             @return The font of label of Nth level
        */
    IFont GetNthLevelLabelFont( ATETextDOM::Int32 index, bool& useOriginalFont);
    
    /** Retrieves the Nth Sequence Generator tag of list object
            @param index : Nth level position
            @param  sequenceGeneratorType - This is type of sequece generator of Nth level of this list
        */
    void GetNthLevelSequenceTag(ATETextDOM::Int32   index,
                                ATE::ListStylePredefinedTag& sequenceGeneratorType);
    /** Retrieves the Nth Sequence Generator prefix
            @param index : Nth level position
            @param prefix - This is the label prefix of Nth level of this list
            @param maxLength The number of characters in the buffer.
            @return The number of characters written to the buffer.
        */
    ATETextDOM::Int32 GetNthLevelSequencePrefix(ATETextDOM::Int32   index,
                                                ATETextDOM::Unicode* prefix,
                                                ATETextDOM::Int32 maxLength);
    
    /** Retrieves the Nth Sequence Generator postfix
            @param index : Nth level position
            @param postfix - This is the label postfix of Nth level of this list
            @param maxLength The number of characters in the buffer.
            @return The number of characters written to the buffer.
        */
    ATETextDOM::Int32 GetNthLevelSequencePostfix(ATETextDOM::Int32   index,
                                                ATETextDOM::Unicode* postfix,
                                                ATETextDOM::Int32 maxLength);
    
    /** Retrieves the Nth Sequence Generator bullet if Nth level is of type BulletSequenceGenerator, else it is invalid
            @param index : Nth level position
            @param bullet - This is the label bullet of Nth level of this list. This is the bullet label of Nth level of this list if Nth level is of type BulletSequenceGenerator, else it is invalid
            @param maxLength The number of characters in the buffer.
            @return The number of characters written to the buffer.
        */
    ATETextDOM::Int32 GetNthLevelSequenceBullet(ATETextDOM::Int32   index,
    ...
    /** Reports whether this object matches a predefined tag in the
        ...
        */
    bool MatchesPredefinedResourceTag( ATE::ListStylePredefinedTag tag) const;
    
    /** Returns the  predefined tag of the ListStyle.
            @return The tag.
        */
    ATE::ListStylePredefinedTag GetPredefinedResourceTag( ) const;

    // =======================================================================
    // METHODS
    // =======================================================================

    /** Reports whether this object is equivalent to another ListStyle object.
            @param rhsListStyle The other ListStyle object.
            @return True if the objects are equivalent.
        */
    bool IsEquivalent( IListStyle rhsListStyle) const;
    /** Reports whether the resource been modified since it became editable.
            @return True if the resource has been modified.
        */
    bool IsModified( ) const;
    /** Reports whether this is a predefined ListStyle.
            @return True if the ListStyle is predefined, false if it is customized.
        */
    bool IsPredefined( ) const;
    
    /** Sets the Nth level Indent Units of  this list object.
            @param index : Nth level position
            @param units: indent units of Nth level
        */
    void SetNthLevelIndentUnits( ATETextDOM::Int32 index, ATE::IndentUnits   units);
    /** Sets the Nth level Text indent of  this list object.
            @param index : Nth level position
            @param indent: text indent of Nth level
        */
    void SetNthLevelTextIndent( ATETextDOM::Int32 index, ATETextDOM::Float indent);
    /** Sets the Nth level Label indent of  this list object.
            @param index : Nth level position
            @param indent: Label indent  of Nth level
        */
    void SetNthLevelLabelIndent( ATETextDOM::Int32 index, ATETextDOM::Float indent);
    /** Sets the Nth level Label Alignment of  this list object.
            @param index : Nth level position
            @param labelAlignment: label Alignment of Nth level
        */
    void SetNthLevelLabelAlignment( ATETextDOM::Int32 index, ATE::BNListAlignment labelAlignment);
    /** Sets the Nth level Label Font of  this list object.
            @param index : Nth level position
            @param font: label Font of Nth level
            @param useOriginalFont: do we need to rememer the font while label rendering
        */
    void SetNthLevelLabelFont(ATETextDOM::Int32 index, IFont font, bool useOriginalFont);
    /** Sets the Nth level Label Font of  this list object.
             @param index : Nth level position
             @param sequenceGeneratorTag: Sequennce type of Nth level
             @param prefix: label prefix Nth level
             @param postfix: label postfix of Nth level
             @param bullet: bullet label of Nth level of this list if Nth level is of type BulletSequenceGenerator, else it is invalid
        */
    void SetNthLevelSequenceGenerator(    ATETextDOM::Int32 index,
    ...
    /** Sets the Nth level Label Font of  this list object.
             @param index : position at which this new level should be inserted inside this list
             @param units: indent units
             @param textIndent: text indent
             @param labelIndent: label indent
             @param labelAlignment: label Alignment of Nth level
             @param font: label Font
             @param useOriginalFont: do we need to rememer the font while label rendering
             @param sequenceGeneratorTag: Sequennce type
             @param prefix: label prefix
             @param postfix: label postfix
             @param bullet: bullet label if sequenceGeneratorTag is of type kPreedefinedBulletSequence else it is invalid
        */
    void InsertLevelAt( ATETextDOM::Int32              index,
    ...
    /** Sets the Nth level Label Font of  this list object.
             @param index : Nth level position
        */
    void EraseLevel( ListStyleRef listStyle, ATETextDOM::Int32 index);
    /** Creates a new object by duplicating the information in this one.
            @return The new object
        */
    IListStyle Duplicate( ) const;
...
//       --IListStyleSet--
//////////////////////////////////////////////
/** Encapsulates a ListStyle set as a text resource. The methods allow you to
    add, access, and manipulate ListStyle sets for use with the
    Adobe Text Engine (ATE). The set contains \c IListStyle objects.
    */
class IListStyleSet
{
private:
    ListStyleSetRef  fListStyleSet;
public:
    /** Constructor
            @return The new object. */
    IListStyleSet();
    /** Copy constructor
            @param src The object to copy.
            @return The new object. */
    IListStyleSet(const IListStyleSet& src);
    /** Assignment operator.
            @param rhs The object to assign to this one.
            @return A reference to this object. */
    IListStyleSet& operator=(const IListStyleSet& rhs);
     /** Comparison operator tests for equality.
            @param rhs The object to compare to this one.
            @return True if the two objects are the same.   */
    bool operator==(const IListStyleSet& rhs) const;
    /** Comparison operator tests for inequality.
            @param rhs The object to compare to this one.
            @return True if the two objects are not the same.   */
    bool operator!=(const IListStyleSet& rhs) const;
    /** Constructs this C++ object from the corresponding C object
        returned by an ATE suite function.
        The C++ object manages reference counting.
            @param ListStyleset The C object.
            @return The new C++ object. */
    explicit IListStyleSet(ListStyleSetRef listStyleset);
    /** Destructor */
    virtual ~IListStyleSet();
    /** Retrieves a reference to this object.
            @return The object reference.   */
    ListStyleSetRef GetRef() const;
    /** Reports whether this is a null object.
            @return True if this is a null object. */
    bool IsNull() const;
    ...
    /** Retrieves a member of this set by position index. Use with \c GetSize()
        to iterate through members.
            ...
            @return The member object.
        */
    IListStyle Item( ATETextDOM::Int32 nIndex) const;
    /** Retrieves a specific ListStyle object from this set, matching name and data.
            @param ListStyle The ListStyle object.
            @return The index position of the object in this set, or -1
                if the object is not in this set.
        */
    ATETextDOM::Int32 Find( const IListStyle listStyle);
    /** Retrieves a specific ListStyle object from this set, matching only the name.
            @param name The object name.
            @return The index position of the object in this set, or -1
                if the object is not in this set.
        */
    ATETextDOM::Int32 Find( const ATETextDOM::Unicode* name);
    /** Retrieves a specific ListStyle object from this set, matching a tag.
            @param tag The tag. Use \c #kUserDefinedListStyleTag to get the first
                customized (not predefined) ListStyle.
            @return The index position of the object in this set, or -1
                if the object is not in this set.
        */
    ATETextDOM::Int32 Find( ListStylePredefinedTag tag);
    /** Removes a member ListStyle from this set.
            @param nIndex The 0-based position index of the ListStyle to remove.
            @return True if a ListStyle was successfully removed.
        */
    bool Remove( ATETextDOM::Int32 nIndex);
    /** Appends a ListStyle to this set.
            @param ListStyle The ListStyle object.
            @param keepPrivate If list is to be kept private,
                       -->  it is not intended to be shown in UI  for user access and will not be returned as part of ListStyleSet
                       -->  since it is private, its index returned is -1
            @return The 0-based position index of the successfully
        ...
        */
    ATETextDOM::Int32 Add( IListStyle listStyle, bool keepPrivate = false);
    /** Replaces a ListStyle in this set.
            @param nIndex The 0-based position index of the ListStyle to replace.
            @param ListStyle The replacement ListStyle object.
            @return True if an object was successfully replaced.
        */
    bool Replace( ATETextDOM::Int32  nIndex, IListStyle listStyle);
...
public:
    ...
    /** Sets a MojiKumi table entry from this object.
            ...
            @return Nothing.
        */
    void GetEntryPriority( ATETextDOM::Int32 index, ATETextDOM::Int32 * priority) const;
    void GetEntryNoFloat( ATETextDOM::Int32 index, ATEBool8 * noFloat) const;
    ...
    void SetEntryPriority( ATETextDOM::Int32 index, ATETextDOM::Int32 priority);
    void SetEntryNoFloat( ATETextDOM::Int32 index, ATEBool8 noFloat);
...
public:
    ...
    /** Retrieves the FrameAlignment for this frame. This moves the text
     *  within the frame according to the desired alignment.
     *
     *  It could be either: top(default), center, bottom, justify
     *
     * @return The FrameAlignment
     */
    FrameAlignment GetFrameAlignment( ) const;

    /** Sets the FrameAlignment for this frame. This moves the text
     *  within the frame according to the desired alignment.
     *
     *  It could be either: top(default), center, bottom, justify
     *
     * @param frameAlignment The frame alignment
     */
    void SetFrameAlignment( FrameAlignment frameAlignment);
};
...
public:
    ...
    IListStyleSet GetListStyleSet( ) const;
...
public:
    ...
    /** Retrieves the Kinsoku set for the document.
        ...
        */
    IKinsokuSet GetKinsokuSet( ) const;
    /** Retrieves the ListStyle set for the document.
            @return The ListStyle set object.
        */
    IListStyleSet GetListStyleSet( ) const;
...
//       --IArrayListStyleRef--
//////////////////////////////////////////////
/** Provides access to an ordered collection of ListStyle objects. */
class IArrayListStyleRef
{
private:
    ArrayListStyleRefRef fArrayListStyleRef;
public:
    /** Constructor
            @return The new object. */
    IArrayListStyleRef();
    /** Copy constructor
            @param src The object to copy.
            @return The new object. */
    IArrayListStyleRef(const IArrayListStyleRef& src);
    /** Assignment operator.
            @param rhs The object to assign to this one.
            @return A reference to this object. */
    IArrayListStyleRef& operator=(const IArrayListStyleRef& rhs);
     /** Comparison operator tests for equality.
            @param rhs The object to compare to this one.
            @return True if the two objects are the same.   */
    bool operator==(const IArrayListStyleRef& rhs) const;
    /** Comparison operator tests for inequality.
            @param rhs The object to compare to this one.
            @return True if the two objects are not the same.   */
    bool operator!=(const IArrayListStyleRef& rhs) const;
    /** Constructs this C++ object from the corresponding C object
        returned by an ATE suite function.
        The C++ object manages reference counting.
            @param arrayListStyleref The C object.
            @return The new C++ object. */
    explicit IArrayListStyleRef(ArrayListStyleRefRef arrayListStyleref);
    /** Destructor */
    virtual ~IArrayListStyleRef();
    /** Retrieves a reference to this object.
            @return The object reference.   */
    ArrayListStyleRefRef GetRef() const;
    /** Reports whether this is a null object.
            @return True if this is a null object. */
    bool IsNull() const;
    ...
    /** Retrieves the first member of this set.
            @return The member object.  */
    IListStyle GetFirst( ) const;
    /** Retrieves the last member of this set.
            @return The member object.  */
    IListStyle GetLast( ) const;
    ...
    /** Retrieves a member of this set by position index. Use with \c GetSize()
        to iterate through members.
            ...
            @return The member object.
        */
    IListStyle Item( ATETextDOM::Int32 index) const;
...
//////////////////////////////////////////////
/** Provides access to an ordered collection of ListStyle set objects. */
class IArrayListStyleSetRef
{
private:
    ArrayListStyleSetRefRef  fArrayListStyleSetRef;
public:
    /** Constructor
            @return The new object. */
    IArrayListStyleSetRef();
    /** Copy constructor
            @param src The object to copy.
            @return The new object. */
    IArrayListStyleSetRef(const IArrayListStyleSetRef& src);
    /** Assignment operator.
            @param rhs The object to assign to this one.
            @return A reference to this object. */
    IArrayListStyleSetRef& operator=(const IArrayListStyleSetRef& rhs);
     /** Comparison operator tests for equality.
            @param rhs The object to compare to this one.
            @return True if the two objects are the same.   */
    bool operator==(const IArrayListStyleSetRef& rhs) const;
    /** Comparison operator tests for inequality.
            @param rhs The object to compare to this one.
            @return True if the two objects are not the same.   */
    bool operator!=(const IArrayListStyleSetRef& rhs) const;
    /** Constructs this C++ object from the corresponding C object
        returned by an ATE suite function.
        The C++ object manages reference counting.
            @param arrayListStylesetref The C object.
            @return The new C++ object. */
    explicit IArrayListStyleSetRef(ArrayListStyleSetRefRef arrayListStylesetref);
    /** Destructor */
    virtual ~IArrayListStyleSetRef();
    /** Retrieves a reference to this object.
            @return The object reference.   */
    ArrayListStyleSetRefRef GetRef() const;
    /** Reports whether this is a null object.
            @return True if this is a null object. */
    bool IsNull() const;
    ...
    /** Retrieves the first member of this set.
            @return The member object.  */
    IListStyleSet GetFirst( ) const;
    /** Retrieves the last member of this set.
            @return The member object.  */
    IListStyleSet GetLast( ) const;
    ...
    /** Retrieves a member of this set by position index. Use with \c GetSize()
        to iterate through members.
            ...
            @return The member object.
        */
    IListStyleSet Item( ATETextDOM::Int32 index) const;
...
public:
    ...
    /** Retrieves the Tate Chu Yoko up-down adjustment attribute of this character style as an integer value.
            @param isAssigned [out] A buffer in which to return
                true if this attribute has a local value.
            @return The up-down adjustment value. */
    ATETextDOM::Int32 GetTCYUpDownAdjustment( bool* isAssigned) const;
    /** Retrieves the Tate Chu Yoko right-left adjustment attribute of this character style as an integer value.
            @param isAssigned [out] A buffer in which to return
                true if this attribute has a local value.
            @return The right-left adjustment value. */
    ATETextDOM::Int32 GetTCYLeftRightAdjustment( bool* isAssigned) const;
    /** Retrieves the Tate Chu Yoko up-down adjustment attribute of this character style as a real value.
            @param isAssigned [out] A buffer in which to return
                true if this attribute has a local value.
            @return The up-down adjustment value. */
    ATETextDOM::Real GetTCYUpDownRealAdjustment( bool* isAssigned) const;
    /** Retrieves the Tate Chu Yoko right-left adjustment attribute of this character style as a real value.
            @param isAssigned [out] A buffer in which to return
                true if this attribute has a local value.
            @return The right-left adjustment value. */
    ATETextDOM::Real GetTCYLeftRightRealAdjustment( bool* isAssigned) const;
    ...
    */
    ...
    /** Sets the local Tate Chu Yoko up-down adjustment attribute of this character as an integer value.
            @param newVal The new adjustment value.
            @return Nothing. */
    void SetTCYUpDownAdjustment( ATETextDOM::Int32 newVal);
    /** Sets the local Tate Chu Yoko right-left adjustment attribute of this character as an integer value.
            @param newVal The new adjustment value.
            @return Nothing. */
    void SetTCYLeftRightAdjustment( ATETextDOM::Int32 newVal);
    /** Sets the local Tate Chu Yoko up-down adjustment attribute of this character as a real value.
            @param newVal The new adjustment value.
            @return Nothing. */
    void SetTCYUpDownRealAdjustment( ATETextDOM::Real newVal);
    /** Sets the local Tate Chu Yoko right-left adjustment attribute of this characte as a real value.
            @param newVal The new adjustment value.
            @return Nothing. */
    void SetTCYLeftRightRealAdjustment( ATETextDOM::Real newVal);
    ...
    */
    ...
    /** Removes the local Tate Chu Yoko up-down adjustment attribute value as an integer value of this character.
            @return Nothing. */
    void ClearTCYUpDownAdjustment( );
    /** Removes the local Tate Chu Yoko right-left adjustment attribute value as an integer value of this character.
            @return Nothing. */
...
public:
    ...
    /** Retrieves the Tate Chu Yoko up-down adjustment values as integer from the character set.
            @return The array object containing the values. */
    IArrayInteger GetTCYUpDownAdjustment( ) const;
    /** Retrieves the Tate Chu Yoko right-left adjustment values as integer from the character set.
            @return The array object containing the values. */
    IArrayInteger GetTCYLeftRightAdjustment( ) const;
    /** Retrieves the Tate Chu Yoko up-down adjustment values as real  from the character set.
            @return The array object containing the values. */
    IArrayReal GetTCYUpDownRealAdjustment( ) const;
    /** Retrieves the Tate Chu Yoko right-left adjustment values as real from the character set.
            @return The array object containing the values. */
    IArrayReal GetTCYLeftRightRealAdjustment( ) const;
...
public:
    ...
    /** Retrieves the ListStyle attribute of this paragraph.
            @param isAssigned [out] A buffer in which to return
                true if this attribute has a local value.
            @return The ListStyle object, or a \c NULL object if ListStyle is not used. */
    IListStyle GetListStyle( bool* isAssigned) const;
    /** Retrieves the  list tier attribute of this paragraph.
            @param isAssigned [out] A buffer in which to return
                true if this attribute has a local value.
            @return The list tier value. */
    ATETextDOM::Int32 GetListTier( bool* isAssigned) const;
    ...
    */
    ...
    /** Sets the local ListStyle attribute of this paragraph.
            @param newVal The new ListStyle object.
            @return Nothing. */
    void SetListStyle( IListStyle newVal);
    /** Sets the tier of listStyle attribute of this paragraph.
            @param newVal The new integer level value object.
            @return Nothing. */
    void SetListTier( ATETextDOM::Int32 newVal);
    ...
    */
    ...
    /** Removes the local Kinsoku attribute value of this paragraph.
            @return Nothing. */
    void ClearKinsoku( );
    /** Removes the local ListStyle attribute value of this paragraph.
            @return Nothing. */
    void ClearListStyle( );
...
public:
    ...
    /** Retrieves the ListStyle values from the paragraph set.
            @return The array object containing the values. */
    IArrayListStyleRef GetListStyle( ) const;
    /** Retrieves the list tier values from the paragraph set
        @return The array object contaning the values */
    IArrayInteger GetListTier() const;
    ...
    */
    ...
    /** Sets the range of search for this spell-check, limiting the search
        to a specific text range within the scope.
            ...
            @param resetCurPos Optional, whether to reset the cursor position after the search.
                Default is true.
            */
    void SetSearchRange( const ITextRange& pRange, const bool resetEndOfSentence = true, const bool resetCurPos = true, const bool includeWordsOnSearchBoundary = true);
    ...
    /** Searches from the start of the range for the first occurrance of an unknown word.
        ...
        list, use \c #GetWordListSize() and GetWordListContents().
            ...
            @param populateSuggestionList true to populate the internal suggestion list that is accessed via GetWordListContents for the incorrect word found, false to not.
    ...
    bool FindOneMisspelledWord( SpellCheckingResult* pResult, ITextRange pRange, Language* pLanguage = NULL, bool populateSuggestionList = true );
    ...
    /**  Reports whether a word is contained in the known-word dictionary for this spell-checker.
            @param pWord A string containing the word.
            @param checkEquivalentFormsSetting Controls the search for equivalent forms
            @return True if the word is in the dictionary. */
    bool WordExistsInUserDictionary( const ATETextDOM::Unicode* pWord, const ATE::CheckEquivalentFormsSetting checkEquivalentFormsSetting);
    /**  Reports whether a word is contained in the ignore List for this spell-checker.
            @param pWord A string containing the word.
            @param checkEquivalentFormsSetting Controls the search for equivalent forms
            @return True if the word is in the ignore List. */
    bool WordExistsInIgnoreDictionary( const ATETextDOM::Unicode* pWord, const ATE::CheckEquivalentFormsSetting checkEquivalentFormsSetting);
...
public:
    ...
    /** Converts the text having list style to a text with no list style and list labels converted to character having same style as text */
    void ConvertListStyleToText();
